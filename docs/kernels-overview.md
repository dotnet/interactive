...
<img src="https://user-images.githubusercontent.com/547415/82159797-c09e8100-9845-11ea-9c1d-cc9a193bf6e9.png" width="100%">
...
<img src="https://user-images.githubusercontent.com/547415/82159170-47049400-9841-11ea-9858-42a82c2c5879.png" width="100%">
...
The submission splitting behavior is implemented using .NET Interactive middleware. Each kernel has its own configurable middleware pipeline. You can think of the middleware pipeline as a set of functions concatenated together. Each function in the chain can choose to perform operations before and/or after calling the continuation that invokes the next function, or can opt to short-circuit the whole pipeline by not calling the continuation at all. This structure allows custom middleware to be added that can perform arbitrary tasks. Examples include executing additional commands (such as in the splitting examples), catching exceptions thrown by the inner operations, outputting timing and diagnostics, checking credentials, and more.

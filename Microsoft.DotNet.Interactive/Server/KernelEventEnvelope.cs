    ...
    public abstract class KernelEventEnvelope : IKernelEventEnvelope
    {
        ...
        static KernelEventEnvelope()
        {
            _envelopeTypesByEventTypeName = new Dictionary<string, Type>
            {
                ...
                [nameof(HoverMarkdownProduced)] = typeof(KernelEventEnvelope<HoverMarkdownProduced>),
                [nameof(HoverPlainTextProduced)] = typeof(KernelEventEnvelope<HoverPlainTextProduced>),

...
export const DiagnosticLogEventProducedType = "DiagnosticLogEventProduced";
...
export type KernelEventType =
    ...
    | typeof DiagnosticLogEventProducedType
...
export interface DiagnosticLogEventProduced extends DiagnosticEventBase {
    message: string;
}

...
public class KernelSchedulerTests : IDisposable
{
    ...
    public KernelSchedulerTests(TestContext output)
    {
    ...
    [TestMethod]
    [Ignore("requires System.Runtime.ControlledExecution")]
    ...
    [TestMethod]
    [Ignore("Disabled pending https://github.com/dotnet/interactive/issues/3236")]

...
describe("kernel event routingSlip", () => {
    it("cannot stamp twice", () => {
        ...
        expect(() => connection.stampEventRoutingSlip(envelope, "kernel://a")).to.throw("The uri kernel://a/ is already in the routing slip [kernel://a/]");
    });
    ...
    it("can append a routing slip to another", () => {
        ...
        let envelope: contracts.KernelEventEnvelope = {
            eventType: contracts.CommandSucceededType,
            event: {},
            routingSlip: connection.createRoutingSlip(["kernel://a", "kernel://b"])
        };
    ...
    it("cannot append a routing slip to another if the other adds in the same kernel", () => {
        ...
        expect(() => connection.continueEventRoutingSlip(envelope, other)).to.throw("The uri kernel://a/ is already in the routing slip [kernel://a/,kernel://b/], cannot continue with routing slip [kernel://a/,kernel://c/,kernel://d/,kernel://e/]");
    });
});
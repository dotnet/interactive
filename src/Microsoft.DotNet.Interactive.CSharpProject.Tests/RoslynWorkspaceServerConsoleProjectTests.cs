...
public class RoslynWorkspaceServerConsoleProjectTests : WorkspaceServerTestsCore
{
    public RoslynWorkspaceServerConsoleProjectTests(PrebuildFixture prebuildFixture, ITestOutputHelper output) : base(prebuildFixture, output)
    {
    }

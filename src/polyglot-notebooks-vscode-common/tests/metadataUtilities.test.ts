...
import {
    CompositeKernel,
    Kernel,
} from "../../src/vscode-common/polyglot-notebooks";
...
describe(`metadata utility tests`, async () => {
    ...
    it("interactive notebook can be identified from metadata in .ipynb", () => {
        let notebookDocument: vscodeLike.NotebookDocument = {
            uri: {
                fsPath: "notebook.ipynb",
                scheme: "untitled",
            },
    ...
    it("cell metadata can be extracted from a notebook cell with old metadata", () => {
        ...
        const notebookCellMetadata =
            metadataUtilities.getNotebookCellMetadataFromNotebookCellElement(
                notebookCell
            );
        expect(notebookCellMetadata).to.deep.equal({
            kernelName: "fsharp",
    ...
    it("notebook metadata can be extracted from an interactive document", () => {
        ...
        const notebookDocumentMetadata =
            metadataUtilities.getNotebookDocumentMetadataFromInteractiveDocument(
                interactiveDocument
            );
    ...
    it("notebook metadata can be extracted from vscode notebook document", () => {
        ...
        const notebookDocumentMetadata =
            metadataUtilities.getNotebookDocumentMetadataFromNotebookDocument(
                notebookDocument
            );
        expect(notebookDocumentMetadata).to.deep.equal({
            kernelInfo: {
    ...
    it("kernel infos can be created from .dib notebook document", () => {
        ...
        const kernelInfos =
            metadataUtilities.getKernelInfosFromNotebookDocument(
                notebookDocument
            );
    ...
    it("notebook metadata can be extracted from a composite kernel", () => {
        ...
        const notebookDocumentMetadata =
            metadataUtilities.getNotebookDocumentMetadataFromCompositeKernel(
                kernel
            );
        expect(notebookDocumentMetadata).to.deep.equal({
            kernelInfo: {
    ...
    it("notebook cell metadata can be created from notebook cell metadata", () => {
        ...
        const rawNotebookDocumentElementMetadata =
            metadataUtilities.getRawNotebookCellMetadataFromNotebookCellMetadata(
    ...
    it("notebook cell metadata can be merged", () => {
        ...
        const resultMetadata = metadataUtilities.mergeNotebookCellMetadata(
            baseMetadata,
    ...
    it("raw metadata can be merged", () => {
        ...
        const resultMetadata = metadataUtilities.mergeRawMetadata(
            baseMetadata,
            metadataWithNewValues
        );
        expect(resultMetadata).to.deep.equal({

...
{
    /// <summary>
    ///   Gets a localized message like: The name of the value to be created in the current kernel.
    /// </summary>
    internal static string Magics_set_name_Description()
        => GetResourceString(Resources.Magics_set_name_Description);

    /// <summary>
    ///   Gets a localized message like: Shares the specified value by reference if kernels are in the same process.
    /// </summary>
    internal static string Magics_set_byref_Description()
        => GetResourceString(Resources.Magics_set_byref_Description);

    /// <summary>
    ///   Gets a localized message like: The MIME type by which the value should be represented. This will often 
    ...
    /// <summary>
    ///   Gets a localized message like: The --mime-type and --byref options cannot be used together.
    /// </summary>
    ...
    /// <summary>
    ///   Gets a localized message like: Sharing by reference is not allowed when kernels are remote.
    /// </summary>
    ...
    /// <summary>
    ///   Gets a localized message like: The value to be set. @input:user_prompt allows you to prompt 
    ...
    /// <summary>
    ///   Gets a localized message like: The name to give the the value in the importing kernel.
    /// </summary>
    internal static string Magics_share_as_Description()
        => GetResourceString(Resources.Magics_share_as_Description);

    /// <summary>
    ///   Gets a localized message like: The name of the kernel to get the value from.
    /// </summary>
    internal static string Magics_share_from_Description()
        => GetResourceString(Resources.Magics_share_from_Description);

    /// <summary>
    ///   Gets a localized message like: Share the value as a string formatted to the specified MIME type.
    /// </summary>
    internal static string Magics_share_mime_type_Description()
        => GetResourceString(Resources.Magics_share_mime_type_Description);

    /// <summary>
    ///   Gets a localized message like: The name of the value to share. (This is also the default name of 
    ...
    /// <summary>
    ///   Gets a localized message like: Runs another notebook or source code file inline.
    /// </summary>
    ...
    internal static string Magics_import_file_Description()
        => GetResourceString(Resources.Magics_import_file_Description);

    /// <summary>
    ///   Gets a localized message like: Specifies a file whose contents will be stored.
    /// </summary>
    internal static string Magics_value_from_file_Description()
        => GetResourceString(Resources.Magics_value_from_file_Description);

    /// <summary>
    ///   Gets a localized message like: Specifies a URL whose content will be stored.
    /// </summary>
    internal static string Magics_value_from_url_Description()
        => GetResourceString(Resources.Magics_value_from_url_Description);

    /// <summary>
    ///   Gets a localized message like: Specifies a value to be stored directly.
    ...
    /// <summary>
    ///   Gets a localized message like: A mime type for the value. If specified, 
    ...
    /// <summary>
    ///   Gets a localized message like: The name of the value to create.
    ...
    /// <summary>
    ///   Gets a localized message like: Display the names of the current top-level variables.
    /// </summary>
    internal static string Magics_who_Description()
        => GetResourceString(Resources.Magics_who_Description);

    /// <summary>
    ///   Gets a localized message like: Display the names of the current top-level variables and their values.
    /// </summary>
    internal static string Magics_whos_Description()
        => GetResourceString(Resources.Magics_whos_Description);

    /// <summary>
    ///   Gets a localized message like: File does not exist: {0}.
    /// </summary>

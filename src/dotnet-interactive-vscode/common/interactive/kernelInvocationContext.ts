...
import { CommandSucceeded, CommandSucceededType, CommandFailed, CommandFailedType, KernelCommandEnvelope, KernelCommand, KernelEventEnvelope, KernelEventType } from "../interfaces/contracts";
import { ConsoleCapture } from "./consoleCapture";
import { IKernelEventObserver, IKernelInvocationContext } from "./kernel";
import { TokenGenerator } from "./tokenGenerator";


export class KernelInvocationContext implements IKernelInvocationContext {
    ...
    static establish(kernelCommandInvocation: KernelCommandEnvelope): IKernelInvocationContext {

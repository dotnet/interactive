...
namespace Microsoft.DotNet.Interactive.PowerShell.Host.Progress
{
    ...
    internal class ProgressNode : ProgressRecord
    {
        ...
        /// </summary>
        internal List<ProgressNode> Children;
        ...
        /// </summary>
        internal RenderStyle Style { get; set; }
        ...
        /// </param>
        internal void Render(List<string> strCollection, int indentation, int maxWidth, PSHostRawUserInterface rawUI)
        {
            switch (Style)
            {
                ...
                case RenderStyle.Invisible:
                    ...
                    break;
                default:
                    Debug.Assert(false, $"Unreachable code - unknown render style '{Style.ToString()}'");
                    break;
            }
        }
        ...
        /// </param>
        private void RenderFull(List<string> strCollection, int indentation, int maxWidth, PSHostRawUserInterface rawUI, bool isFullPlus)
        {
            ...
            {
                strCollection.Add(string.Empty);
        ...
        /// The PSHostRawUserInterface used to gauge string widths in the rendering.
        /// </param>
        private void RenderCompact(List<string> strCollection, int indentation, int maxWidth, PSHostRawUserInterface rawUI)
        {
            string indent = StringUtil.Padding(indentation);
        ...
        /// The PSHostRawUserInterface used to gauge string widths in the rendering.
        /// </param>
        private void RenderMinimal(List<string> strCollection, int indentation, int maxWidth, PSHostRawUserInterface rawUI)
        {
            string indent = StringUtil.Padding(indentation);
        ...
        private int LinesRequiredInFullStyleMethod(PSHostRawUserInterface rawUi, int maxWidth, bool isFullPlus)
        {
            ...
            // We assume 1 line for each field.  If we ever need to word-wrap text fields, then this calculation will need updating.
